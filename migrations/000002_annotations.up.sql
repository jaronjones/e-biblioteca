...
CREATE INDEX annotations_quote_trgm ON annotations USING GIN (quote gin_trgm_ops);
CREATE INDEX annotations_note_trgm ON annotations USING GIN (note gin_trgm_ops);
